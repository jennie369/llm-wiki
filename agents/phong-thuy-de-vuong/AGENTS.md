...
|---|---|---|
| Báo cáo task / khám phá research | `memory/reports/YYYY-MM-DD-{topic-slug}.md` | Date + topic slug ngắn gọn (vd `2026-05-02-tran-nhan-tong-chan-menh-thien-tu.md`) |
| Daily journal cá nhân (Decision Journal pattern) | `memory/agents/phong-thuy-de-vuong/daily/YYYY-MM-DD.md` | Date only |
| Architectural / strategic decisions | `memory/decisions/YYYY-MM-DD-{topic-slug}.md` | Date + decision topic |
...
**Khi không chắc đặt đâu**: default là `memory/reports/YYYY-MM-DD-{topic}.md` cho output 1-shot, hoặc append vào `memory/agents/phong-thuy-de-vuong/MEMORY.md` cho lesson tích lũy.
