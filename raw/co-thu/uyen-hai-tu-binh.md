...
times: "明"
author: "楊淙"
source: "https://zh.wikisource.org/wiki/淵海子平"
source_note: "Nguyên văn Hán (MediaWiki wikitext) từ Wikisource tiếng Trung — public domain (cổ thư). KHÔNG dịch, KHÔNG sửa."
format: wikitext
fetched: 2026-06-12
immutable: true
tags: [karma-engine, co-thu, bat_tu]
---

<!-- Uyên Hải Tử Bình — cổ thư Tử Bình (Bát Tự) nền tảng. Cho Bát Tự matcher đợt C. -->

{{Header|title=淵海子平|author=楊淙|section=|times=明|previous=|next=|type=|from=|notes=}}
{{wwc}}
{{傳統漢字化}}
{{No source}}
